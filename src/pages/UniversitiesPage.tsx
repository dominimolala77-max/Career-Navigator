...
import { ArrowRight, GraduationCap, Search, AlertCircle } from "lucide-react";
          ...
          <div key={u.id} className="cp-card flex flex-col p-5">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2 text-center text-xs">
              ...
              <div className="rounded-lg bg-slate-50 p-2">
                ...
                <p className="font-extrabold text-[#006B5E]">R{getInstitutionApplicationFee(u)}</p>
              </div>
            </div>
            ...
            <div className="p-6 grid gap-4 text-sm">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  { l: "Application Fee", v: `R${getInstitutionApplicationFee(selected)}` },
                ].map(item => (
