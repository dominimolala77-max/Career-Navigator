...
export interface Institution {
  id: string;
  name: string;
  type: "public_university" | "tvet_college" | "private_institution";
  province: string;
  website: string;
